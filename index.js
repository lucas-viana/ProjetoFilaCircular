...
//--------------------------------------------------------------------------------------------
 ...
 let elementoRemovido =  minhaFila.dequeue();
 const hora = obterHoraAtual();
 let tempoAtendimento = calcularDiferencaHoras(elementoRemovido.hora, hora);
 console.log(tempoAtendimento);
 document.getElementById("mensagem-remocao").innerHTML = elementoRemovido +" Hora de saida - "+ hora + " - Tempo de atendimento -> "+ tempoAtendimento;
 atualizarFila();
 limparCampos();
 }
 //--------------------------------------------------------------------------------
